...
import exterior1 from './images/exterior1.png';
import exterior2  from './images/exterior2.png';
import exterior3 from './images/exterior3.png';
  ...
  return (
    <div className="App">
      ...
      <div className='DatosHome' id="regalos" style={{backgroundColor: '#2e266d', paddingBottom: '20px', marginBottom: '20px'}}>
        ...
        <h2 style={{ margin: '20px 0 0px 0', color: '#989fa1', backgroundColor: '#2e266d'}}>Número de cuenta</h2>
      </div>
